...
for(var index=0;index<Math.floor(window.innerWidth/16);index++){
	new staticParticle(userChosenParticles=particleValues,userChosenColors=Array("white"),maxSpeed=4,minSpeed=2,maxSize=7,minSize=4,spinSpeed="slow",colorFlux=false,flipParticle=false,lockDirection=false);
}
</script>
