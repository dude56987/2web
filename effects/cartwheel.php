...
for(var index=0;index<Math.floor(window.innerHeight/64);index++){
	new flyingParticle(userChosenParticles=particleValues,userChosenColors=Array("white"),maxSpeed=10,minSpeed=9,maxSize=5,minSize=3,spinSpeed="fast",fluxColor=false,flipParticle=false,lockSpinDirection=true);
}
