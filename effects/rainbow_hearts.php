	...
	class snowflake{
		constructor(){
			//setTimeout( () => {
				...
				this.flakeType=Math.floor(Math.random() * 10);
				if(0 == this.flakeType ){
					this.snowFlakeDiv.innerHTML="🩷";
				}else if(1 == this.flakeType ){
					this.snowFlakeDiv.innerHTML="🧡";
				}else if(2 == this.flakeType ){
					this.snowFlakeDiv.innerHTML="💛";
				}else if(3 == this.flakeType ){
					this.snowFlakeDiv.innerHTML="💚";
				}else if(4 == this.flakeType ){
					this.snowFlakeDiv.innerHTML="💙";
				}else if(5 == this.flakeType ){
					this.snowFlakeDiv.innerHTML="🩵";
				}else if(6 == this.flakeType ){
					this.snowFlakeDiv.innerHTML="💜";
				}else if(7 == this.flakeType ){
					this.snowFlakeDiv.innerHTML="🤎";
				}else if(8 == this.flakeType ){
					this.snowFlakeDiv.innerHTML="🤍";
				}else if(9 == this.flakeType ){
				...
				setInterval( () => {
					...
					if ( (parseInt(tempFlake.style.top) > (window.innerHeight+100)) || (parseInt(tempFlake.style.left) > window.innerWidth) ){
