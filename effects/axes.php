...
for(var index=0;index<Math.floor(window.innerHeight/64);index++){
	new flyingParticle(userChosenParticles=particleValues,userChosenColors=Array("white"),maxSpeed=19,minSpeed=17,maxSize=5,minSize=3,spinSpeed="superfast",fluxColor=false,flipParticle=false,lockSpinDirection=true);
}
</script>
